...
$stmt = lex_pdo()->prepare(
    'SELECT mp.*, c.user_id AS client_user_id, l.user_id AS lawyer_user_id
...
$isLawyerOwner = $role === 'lawyer' && $currentUserId === (int) ($payment['lawyer_user_id'] ?? 0);
$isAdmin = $role === 'admin';
if (!$isOwner && !$isLawyerOwner && !$isAdmin) {
